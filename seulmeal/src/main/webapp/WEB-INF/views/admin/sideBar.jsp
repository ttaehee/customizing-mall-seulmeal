	        ...
	        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
	            ...
	            <li>
	                ...
	                <ul class="collapse nav flex-column ms-1" id="submenu2" data-bs-parent="#menu">
	                    <li class="w-100">
	                        <a href="/product/admin/listProduct/1" class="nav-link px-0"> <span class="d-none d-sm-inline">판매 상품</span></a>
	                    </li>
	                    <li>
	                        <a href="/product/listParts/1/0" class="nav-link px-0"> <span class="d-none d-sm-inline">판매 재료</span></a>
	                    </li>
	                    <li>
	                        <a href="/product/listFoodCategory" class="nav-link px-0"> <span class="d-none d-sm-inline">음식카테고리</span></a>
	                    </li>
	                </ul>
	            </li>
	            <li>
